...
public class ELP_FULLSCREEN extends PApplet {
...
public void draw(){
  ...
  // 720 - 640 = 80
  //
  image(sorted, 0   ,40, 640, 640);
  image(imgdif, 640 ,40, 640, 640);
}
...
public void loadColors(String filename){
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "ELP_FULLSCREEN" });
  }
}
